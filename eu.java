public class eu implements gh {
   ...
   public boolean a(eu var1) {
      ...
      for(int var3 = 0; var3 < this.b.length; ++var3) {
         if (!this.a(var1.b[var3], this.b[var3])) {
            return false;
         }
      }

      for(int var4 = 0; var4 < this.c.length; ++var4) {
         if (!this.a(var1.c[var4], this.c[var4])) {
            return false;
         }
      }
   ...
   private boolean a(ev var1, ev var2) {
      if (var1 == null && var2 == null) {
         ...
         return var1.c == var2.c && var1.a == var2.a && var1.d == var2.d;
      } else {
         return false;
      }
   }
   ...
   public eu i() {
      ...
      for(int var3 = 0; var3 < this.b.length; ++var3) {
         var1.b[var3] = this.b[var3] != null ? this.b[var3].e() : null;
      }

      for(int var4 = 0; var4 < this.c.length; ++var4) {
         var1.c[var4] = this.c[var4] != null ? this.c[var4].e() : null;
      }

public class kn {
   ...
   public kn(by var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      this.a = var1;
      this.b = var2;
      this.c = var3;
      this.d = var4;
                  ...
                  for(int var8 = this.c; var8 <= this.f; ++var8) {
                     if (var8 >= 0 && var8 < 128) {
                        ...
                        if (var12 >= 15 && var13 == 0) {
                           ...
                           int var14 = var1.a(this.a, var6 - 1, var8, var7);
                        ...
                        if (var9 != var10) {
                           var1.b(this.a, var6, var8, var7, var10);
                           int var22 = var10 - 1;
                           if (var22 < 0) {
                              var22 = 0;
                           }

                           var1.a(this.a, var6 - 1, var8, var7, var22);
                           var1.a(this.a, var6, var8 - 1, var7, var22);
                           var1.a(this.a, var6, var8, var7 - 1, var22);
                           if (var6 + 1 >= this.e) {
                              var1.a(this.a, var6 + 1, var8, var7, var22);
                           }

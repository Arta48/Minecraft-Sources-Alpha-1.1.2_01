...
public class Library {
   ...
   public void init() {
      ...
      for(int var2 = 0; var2 < SoundSystemConfig.getNumberStreamingChannels(); ++var2) {
         Channel var3 = this.createChannel(1);
         if (var3 == null) {
            break;
         }

         this.streamingChannels.add(var3);
      }

      for(int var5 = 0; var5 < SoundSystemConfig.getNumberNormalChannels(); ++var5) {
         Channel var4 = this.createChannel(0);
         if (var4 == null) {
            break;
         }

         this.normalChannels.add(var4);
      }
   ...
   public void loadMidi(boolean var1, String var2, FilenameURL var3) {
      ...
      } else if (!var3.getFilename().matches(".*[mM][iI][dD][iI]?$")) {
   ...
   public boolean midiSourcename(String var1) {
      if (this.midiChannel != null && var1 != null) {
         if (this.midiChannel.getSourcename() != null && !var1.equals("")) {
            return var1.equals(this.midiChannel.getSourcename());
         } else {
            return false;
         }
      } else {

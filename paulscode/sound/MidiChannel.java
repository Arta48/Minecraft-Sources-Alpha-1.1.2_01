...
public class MidiChannel implements MetaEventListener {
   ...
   public void fadeOut(FilenameURL var1, long var2) {
      if (var2 < 0L) {
         ...
         if (this.fadeThread == null) {
            this.fadeThread = new MidiChannel$FadeThread(this, (MidiChannel$1)null);
   ...
   private Sequencer openSequencer(String var1) {
      Object var2 = null;
      Sequencer var5 = (Sequencer)this.openMidiDevice(var1);
      if (var5 == null) {
         return null;
      } else {
         try {

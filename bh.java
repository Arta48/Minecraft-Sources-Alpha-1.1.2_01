...
public class bh extends lm {
   ...
   public void e() {
      if (Mouse.getEventButtonState()) {
         int var1 = Mouse.getEventX() * this.c / this.b.c;
         int var2 = this.d - Mouse.getEventY() * this.d / this.b.d - 1;
         this.a(var1, var2, Mouse.getEventButton());
      } else {
         int var3 = Mouse.getEventX() * this.c / this.b.c;
         int var4 = this.d - Mouse.getEventY() * this.d / this.b.d - 1;
         this.b(var3, var4, Mouse.getEventButton());
      }
   ...
   public void b(int var1) {
      ...
      var2.b();
      var2.b(4210752);
      var2.a((double)0.0F, (double)this.d, (double)0.0F, (double)0.0F, (double)((float)this.d / var3 + (float)var1));
      var2.a((double)this.c, (double)this.d, (double)0.0F, (double)((float)this.c / var3), (double)((float)this.d / var3 + (float)var1));
      var2.a((double)this.c, (double)0.0F, (double)0.0F, (double)((float)this.c / var3), (double)(0 + var1));
      var2.a((double)0.0F, (double)0.0F, (double)0.0F, (double)0.0F, (double)(0 + var1));
      var2.a();
   }

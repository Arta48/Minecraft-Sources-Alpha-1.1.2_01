public class ke extends ic implements gh {
   ...
   private boolean j() {
      if (this.a[0] == null) {
         ...
         if (var1 < 0) {
            ...
            return false;
         } else if (this.a[2].a < this.e() && this.a[2].a < this.a[2].c()) {
            return true;
         } else {
            return this.a[2].a < di.c[var1].b();
         }
      }
   }
   ...
   private int d(int var1) {
      if (var1 == ly.I.bc) {
         return di.m.aS;
      } else if (var1 == ly.H.bc) {
         return di.n.aS;
      } else if (var1 == ly.ax.bc) {
         return di.l.aS;
      } else if (var1 == ly.F.bc) {
         return ly.N.bc;
      } else if (var1 == di.ao.aS) {
         return di.ap.aS;
      } else if (var1 == ly.x.bc) {
         return ly.u.bc;
      } else {
         return var1 == di.aG.aS ? di.aF.aS : -1;
      }
   }
   ...
   private int a(ev var1) {
      if (var1 == null) {
         ...
         int var2 = var1.a().aS;
         if (var2 < 256 && ly.n[var2].bn == gb.c) {
            return 300;
         } else if (var2 == di.B.aS) {
            return 100;
         } else if (var2 == di.k.aS) {
            return 1600;
         } else {
            return var2 == di.aw.aS ? 20000 : 0;
         }
      }
   }
}

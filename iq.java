...
public class iq {
   ...
   public void a(float var1) {
      if (this.h.g != null) {
         ...
         this.k = null;
         List var9 = this.h.e.b((kh)this.h.g, (cf)this.h.g.au.a(var7.a * var2, var7.b * var2, var7.c * var2));
         ...
         for(int var12 = 0; var12 < var9.size(); ++var12) {
            ...
            if (var13.c_()) {
               ...
               if (var16 != null) {
                  ...
                  if (var17 < var10 || var10 == (double)0.0F) {
                     this.k = var13;
                     var10 = var17;
                  }
               }
   ...
   private void e(float var1) {
      ...
      if (!(var3 < 0.0F)) {
         var3 /= (float)var2.H;
         var3 = eo.a(var3 * var3 * var3 * var3 * (float)Math.PI);
         float var7 = var2.I;
   ...
   private void f(float var1) {
      if (!this.h.y.x) {
         ...
         GL11.glTranslatef(eo.a(var4 * (float)Math.PI) * var5 * 0.5F, -Math.abs(eo.b(var4 * (float)Math.PI) * var5), 0.0F);
         GL11.glRotatef(eo.a(var4 * (float)Math.PI) * var5 * 3.0F, 0.0F, 0.0F, 1.0F);
         GL11.glRotatef(Math.abs(eo.b(var4 * (float)Math.PI + 0.2F) * var5) * 5.0F, 1.0F, 0.0F, 0.0F);
   ...
   private void g(float var1) {
      ...
      if (this.h.y.x) {
         ...
         float var11 = var2.aq;
         float var12 = var2.ar;
         double var13 = (double)(-eo.a(var11 / 180.0F * (float)Math.PI) * eo.b(var12 / 180.0F * (float)Math.PI)) * var9;
         double var15 = (double)(eo.b(var11 / 180.0F * (float)Math.PI) * eo.b(var12 / 180.0F * (float)Math.PI)) * var9;
         double var17 = (double)(-eo.a(var12 / 180.0F * (float)Math.PI)) * var9;
   ...
   public void c(float var1) {
      ...
      for(int var11 = 0; var11 < 2; ++var11) {
         ...
         i.b();
         var3.a(((dm)var2).e(var1), var12, var1);
         var4.b(var2, var1);
         i.a();
         this.a(0);
         var4.a(var2, var1);
         if (this.h.x != null && ((dm)var2).a((gb)gb.f)) {
            GL11.glDisable(3008);
      ...
      for(int var15 = var4 - var14; var15 <= var4 + var14; ++var15) {
         for(int var16 = var6 - var14; var16 <= var6 + var14; ++var16) {
            ...
            if (var18 != var19) {
               ...
               var7.b(-var8 * (double)1.0F, -var10 * (double)1.0F, -var12 * (double)1.0F);
               ...
               var7.b((double)0.0F, (double)0.0F, (double)0.0F);
               var7.a();
            }
         }
      }
   ...
   private void i(float var1) {
      ...
      if (((dm)var3).a((gb)gb.f)) {
         this.e = 0.02F;
         this.f = 0.02F;
         this.g = 0.2F;
      } else if (((dm)var3).a((gb)gb.g)) {
         this.e = 0.6F;
         this.f = 0.1F;
         this.g = 0.0F;
      }

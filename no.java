public class no extends ly {
   protected no(int var1, int var2) {
   ...
   public void e(cn var1, int var2, int var3, int var4) {
      if (var1.g(var2 - 1, var3, var4)) {
         ...
         var1.b(var2, var3, var4, 5 + var1.n.nextInt(2));
      }
   ...
   public boolean a(cn var1, int var2, int var3, int var4, dm var5) {
      ...
      var1.a((double)var2 + (double)0.5F, (double)var3 + (double)0.5F, (double)var4 + (double)0.5F, "random.click", 0.3F, var8 > 0 ? 0.6F : 0.5F);

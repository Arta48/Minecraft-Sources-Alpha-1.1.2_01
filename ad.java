...
public class ad extends Canvas implements KeyListener, MouseListener, MouseMotionListener, Runnable {
   private int a = 0;
   private int b = 2;
   ...
   private static fa e() {
      ...
      if (var0.contains("win")) {
         ...
         return var0.contains("unix") ? fa.a : fa.e;
      }
   }
   ...
   public ad() {
      for(int var1 = 0; var1 < 64; ++var1) {
         for(int var2 = 0; var2 < 64; ++var2) {
            this.h[var1][var2] = new jj((cn)null, var1, var2);
         }
      }
   ...
   public void b(String var1) {
      this.i = this.j = 0;
      this.d = new lk(this, new File(this.e, "saves"), var1);
      this.d.e = 0;
      synchronized(this.g) {
         this.g.clear();
   ...
   private jj a(int var1, int var2) {
      int var3 = var1 & 63;
      int var4 = var2 & 63;
      jj var5 = this.h[var3][var4];
   ...
   public void a(Graphics2D var1) {
      ...
      if (this.d != null) {
         var1.translate(-(this.d.o + this.d.q), -(-this.d.o + this.d.q) + 64);
      }
      ...
      if (this.c) {
         ...
         var1.drawString(var18, this.getWidth() / 2 - var1.getFontMetrics().stringWidth(var18) / 2, var17 + 20);
      }

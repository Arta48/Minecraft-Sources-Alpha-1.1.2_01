...
public class j extends bt {
   ...
   private FloatBuffer f = df.d(16);
   private FloatBuffer g = df.d(16);
   private FloatBuffer h = df.d(16);
   ...
   private void a(float[][] var1, int var2) {
      float var3 = eo.c(var1[var2][0] * var1[var2][0] + var1[var2][1] * var1[var2][1] + var1[var2][2] * var1[var2][2]);
      var1[var2][0] /= var3;
      var1[var2][1] /= var3;
      var1[var2][2] /= var3;
      var1[var2][3] /= var3;
   ...
   private void b() {
      ...
      this.g.clear();
      this.h.clear();
      GL11.glGetFloat(2983, this.f);
      GL11.glGetFloat(2982, this.g);

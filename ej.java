...
public class ej extends ik {
   ...
   void a() {
      ...
      int var1 = (int)(1.382 + Math.pow(this.k * (double)this.e / (double)13.0F, (double)2.0F));
      if (var1 < 1) {
         var1 = 1;
      }
      ...
      while(var6 >= 0) {
         ...
         if (var8 < 0.0F) {
            ...
            for(double var9 = (double)0.5F; var7 < var1; ++var7) {
               double var11 = this.j * (double)var8 * ((double)this.b.nextFloat() + 0.328);
               double var13 = (double)this.b.nextFloat() * (double)2.0F * 3.14159;
               int var15 = (int)(var11 * Math.sin(var13) + (double)this.d[0] + var9);
               int var16 = (int)(var11 * Math.cos(var13) + (double)this.d[2] + var9);
               int[] var17 = new int[]{var15, var3, var16};
               int[] var18 = new int[]{var15, var3 + this.n, var16};
               if (this.a(var17, var18) == -1) {
                  int[] var19 = new int[]{this.d[0], this.d[1], this.d[2]};
                  double var20 = Math.sqrt(Math.pow((double)Math.abs(this.d[0] - var17[0]), (double)2.0F) + Math.pow((double)Math.abs(this.d[2] - var17[2]), (double)2.0F));
      ...
      for(var11[var5] = var10[var5]; var12 <= var7; ++var12) {
         ...
         while(var13 <= var7) {
            ...
            if (var15 > (double)var4) {
               ...
               int var14 = this.c.a(var11[0], var11[1], var11[2]);
               if (var14 != 0 && var14 != 18) {
                  ++var13;
               } else {
                  this.c.a(var11[0], var11[1], var11[2], var6);
                  ++var13;
               }
            }
         }
   ...
   float a(int var1) {
      if ((double)var1 < (double)((float)this.e) * 0.3) {
         return -1.618F;
      } else {
   ...
   float b(int var1) {
      if (var1 >= 0 && var1 < this.n) {
         return var1 != 0 && var1 != this.n - 1 ? 3.0F : 2.0F;
      } else {
         return -1.0F;
      }
   }
   ...
   void a(int[] var1, int[] var2, int var3) {
      ...
      if (var4[var6] != 0) {
         ...
         for(int var16 = var4[var6] + var9; var15 != var16; var15 += var9) {
            var14[var6] = eo.b((double)(var1[var6] + var15) + (double)0.5F);
            var14[var7] = eo.b((double)var1[var7] + (double)var15 * var10 + (double)0.5F);
            var14[var8] = eo.b((double)var1[var8] + (double)var15 * var12 + (double)0.5F);
            this.c.a(var14[0], var14[1], var14[2], var3);
         }
   ...
   boolean c(int var1) {
      return !((double)var1 < (double)this.e * 0.2);
   }

...
public class bq {
   ...
   public void a(kh var1, float var2) {
      float var3 = eo.b(var1.aq * (float)Math.PI / 180.0F);
      float var4 = eo.a(var1.aq * (float)Math.PI / 180.0F);
      float var5 = -var4 * eo.a(var1.ar * (float)Math.PI / 180.0F);
      float var6 = var3 * eo.a(var1.ar * (float)Math.PI / 180.0F);
      float var7 = eo.b(var1.ar * (float)Math.PI / 180.0F);
         ...
         for(int var7 = 0; var7 < var6; ++var7) {
            for(int var8 = 0; var8 < var6; ++var8) {
               for(int var9 = 0; var9 < var6; ++var9) {
                  double var10 = (double)var1 + ((double)var7 + (double)0.5F) / (double)var6;
                  double var12 = (double)var2 + ((double)var8 + (double)0.5F) / (double)var6;
                  double var14 = (double)var3 + ((double)var9 + (double)0.5F) / (double)var6;
                  this.a((nq)(new iw(this.a, var10, var12, var14, var10 - (double)var1 - (double)0.5F, var12 - (double)var2 - (double)0.5F, var14 - (double)var3 - (double)0.5F, var5)));
               }
            }
         }
   ...
   public void a(int var1, int var2, int var3, int var4) {
      ...
      if (var5 != 0) {
         ...
         this.a((new iw(this.a, var8, var10, var12, (double)0.0F, (double)0.0F, (double)0.0F, var6)).b(0.2F).d(0.6F));
      }
   }

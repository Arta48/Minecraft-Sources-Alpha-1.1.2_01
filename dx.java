public class dx extends kh {
   ...
   public int c;
   private int f = 5;
   public float d = (float)(Math.random() * Math.PI * (double)2.0F);
   ...
   public dx(cn var1, double var2, double var4, double var6, ev var8) {
      ...
      this.a = var8;
      this.aq = (float)(Math.random() * (double)360.0F);
      this.an = (double)((float)(Math.random() * (double)0.2F - (double)0.1F));
      this.ao = (double)0.2F;
      this.ap = (double)((float)(Math.random() * (double)0.2F - (double)0.1F));
      this.aG = false;
   }

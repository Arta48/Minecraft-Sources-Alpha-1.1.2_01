...
public class lo extends ee {
   ...
   public lo(gh var1, ev[] var2) {
      ...
      for(int var5 = 0; var5 < 4; ++var5) {
         this.i.add(new lj(this, this, var1, var1.c() - 1 - var5, 8, 8 + var5 * 18, var5));
      }

      for(int var6 = 0; var6 < 3; ++var6) {
         for(int var8 = 0; var8 < 9; ++var8) {
            this.i.add(new mm(this, var1, var8 + (var6 + 1) * 9, 8 + var8 * 18, 84 + var6 * 18));
         }
      }

      for(int var7 = 0; var7 < 9; ++var7) {
         this.i.add(new mm(this, var1, var7, 8 + var7 * 18, 142));
      }
   ...
   protected void a(float var1) {
      ...
      kx.a.a(this.b.g, (double)0.0F, (double)0.0F, (double)0.0F, 0.0F, 1.0F);
      this.b.g.n = var6;
      this.b.g.aq = var7;
      this.b.g.ar = var8;
      GL11.glPopMatrix();

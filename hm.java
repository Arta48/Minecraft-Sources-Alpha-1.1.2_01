...
public class hm extends el {
   ...
   public void a(String var1, byte var2) {
      this.a.put(var1, (new ix(var2)).a((String)var1));
   }

   public void a(String var1, short var2) {
      this.a.put(var1, (new ls(var2)).a((String)var1));
   }

   public void a(String var1, int var2) {
      this.a.put(var1, (new io(var2)).a((String)var1));
   }

   public void a(String var1, long var2) {
      this.a.put(var1, (new gn(var2)).a((String)var1));
   }

   public void a(String var1, float var2) {
      this.a.put(var1, (new f(var2)).a((String)var1));
   }

   public void a(String var1, double var2) {
      this.a.put(var1, (new kr(var2)).a((String)var1));
   }

   public void a(String var1, String var2) {
      this.a.put(var1, (new ne(var2)).a((String)var1));
   }

   public void a(String var1, byte[] var2) {
      this.a.put(var1, (new dy(var2)).a((String)var1));
   }
   ...
   public double h(String var1) {
      return !this.a.containsKey(var1) ? (double)0.0F : ((kr)this.a.get(var1)).a;
   }

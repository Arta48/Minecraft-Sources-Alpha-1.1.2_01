public class me extends di {
   ...
   public ev a(ev var1, cn var2, dm var3) {
      ...
      float var14 = eo.b(-var6 * ((float)Math.PI / 180F) - (float)Math.PI);
      float var15 = eo.a(-var6 * ((float)Math.PI / 180F) - (float)Math.PI);
      float var16 = -eo.b(-var5 * ((float)Math.PI / 180F));
      float var17 = eo.a(-var5 * ((float)Math.PI / 180F));

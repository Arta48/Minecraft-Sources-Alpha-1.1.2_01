...
public class bg extends mj {
   ...
   private boolean h(cn var1, int var2, int var3, int var4) {
      ...
      if (var5 == 5 && var1.k(var2, var3 - 1, var4, 0)) {
         return true;
      } else if (var5 == 3 && var1.k(var2, var3, var4 - 1, 2)) {
         return true;
      } else if (var5 == 4 && var1.k(var2, var3, var4 + 1, 3)) {
         return true;
      } else if (var5 == 1 && var1.k(var2 - 1, var3, var4, 4)) {
         return true;
      } else {
         return var5 == 2 && var1.k(var2 + 1, var3, var4, 5);
      }
   }
         ...
         if (var6) {
            ...
            if (this.a(var1, var2, var3, var4, true)) {
               ...
               for(int var7 = 0; var7 < 5; ++var7) {
                  ...
                  var1.a("smoke", var8, var10, var12, (double)0.0F, (double)0.0F, (double)0.0F);
               }
            }
         }
   ...
   public void b(cn var1, int var2, int var3, int var4, Random var5) {
      if (this.a) {
         ...
         if (var6 == 1) {
            var1.a("reddust", var7 - var15, var9 + var13, var11, (double)0.0F, (double)0.0F, (double)0.0F);
         } else if (var6 == 2) {
            var1.a("reddust", var7 + var15, var9 + var13, var11, (double)0.0F, (double)0.0F, (double)0.0F);
         } else if (var6 == 3) {
            var1.a("reddust", var7, var9 + var13, var11 - var15, (double)0.0F, (double)0.0F, (double)0.0F);
         } else if (var6 == 4) {
            var1.a("reddust", var7, var9 + var13, var11 + var15, (double)0.0F, (double)0.0F, (double)0.0F);
         } else {
            var1.a("reddust", var7, var9, var11, (double)0.0F, (double)0.0F, (double)0.0F);
         }

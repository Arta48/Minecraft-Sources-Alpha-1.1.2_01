...
public class iz extends hi {
   ...
   protected iz(int var1, int var2) {
      super(var1, var2, gb.h, false);
      this.b = var2;
      this.b(true);
   }
   ...
   public void f(cn var1, int var2, int var3, int var4, int var5) {
   ...
   public void h(cn var1, int var2, int var3, int var4) {
      if (this.c++ < 100) {

...
public class b extends jt {
      ...
      if (var5 == 1) {
         ...
         if (var6 != this.bc && var7 != this.bc) {
            if (var8 != this.bc && var9 != this.bc) {
               ...
               return var5 == var15 ? this.bb + 1 : this.bb;
               ...
               int var16 = var1.a(var8 == this.bc ? var2 - 1 : var2 + 1, var3, var4 - 1);
               int var17 = var1.a(var8 == this.bc ? var2 - 1 : var2 + 1, var3, var4 + 1);
               if (var5 == 3) {
                  var14 = -1 - var14;
               }

               byte var18 = 3;
               if ((ly.p[var6] || ly.p[var16]) && !ly.p[var7] && !ly.p[var17]) {
                  var18 = 3;
               }

               if ((ly.p[var7] || ly.p[var17]) && !ly.p[var6] && !ly.p[var16]) {
                  var18 = 2;
               }

               return (var5 == var18 ? this.bb + 16 : this.bb + 32) + var14;
            } else {
               return this.bb;
            }
            ...
            int var11 = var1.a(var2 - 1, var3, var6 == this.bc ? var4 - 1 : var4 + 1);
            int var12 = var1.a(var2 + 1, var3, var6 == this.bc ? var4 - 1 : var4 + 1);
            if (var5 == 4) {
               var10 = -1 - var10;
            }
   ...
   public int a(int var1) {
      if (var1 == 1) {
         ...
         return var1 == 3 ? this.bb + 1 : this.bb;
      }
   }
   ...
   public boolean a(cn var1, int var2, int var3, int var4) {
      ...
      if (var5 > 1) {
         return false;
      } else if (this.h(var1, var2 - 1, var3, var4)) {
         return false;
      } else if (this.h(var1, var2 + 1, var3, var4)) {
         return false;
      } else if (this.h(var1, var2, var3, var4 - 1)) {
         return false;
      } else {
         return !this.h(var1, var2, var3, var4 + 1);
      }
   }
   ...
   private boolean h(cn var1, int var2, int var3, int var4) {
      if (var1.a(var2, var3, var4) != this.bc) {
         return false;
      } else if (var1.a(var2 - 1, var3, var4) == this.bc) {
         return true;
      } else if (var1.a(var2 + 1, var3, var4) == this.bc) {
         return true;
      } else if (var1.a(var2, var3, var4 - 1) == this.bc) {
         return true;
      } else {
         return var1.a(var2, var3, var4 + 1) == this.bc;
      }
   }

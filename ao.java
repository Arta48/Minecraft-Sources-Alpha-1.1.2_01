...
public class ao extends kh {
   ...
   public boolean a(double var1) {
      double var3 = this.au.b() * (double)4.0F;
      var3 *= (double)64.0F;
      return var1 < var3 * var3;
   }

   public ao(cn var1, ge var2) {
      super(var1);
      this.g = var2;
      this.a(0.25F, 0.25F);
      ...
      this.aB = 0.0F;
      float var3 = 0.4F;
      this.an = (double)(-eo.a(this.aq / 180.0F * (float)Math.PI) * eo.b(this.ar / 180.0F * (float)Math.PI) * var3);
      this.ap = (double)(eo.b(this.aq / 180.0F * (float)Math.PI) * eo.b(this.ar / 180.0F * (float)Math.PI) * var3);
      this.ao = (double)(-eo.a(this.ar / 180.0F * (float)Math.PI) * var3);
   ...
   public void e_() {
      ...
      if (var3 != null) {
         ...
         for(int var18 = 0; var18 < 8; ++var18) {
            this.ag.a("snowballpoof", this.ak, this.al, this.am, (double)0.0F, (double)0.0F, (double)0.0F);
         }

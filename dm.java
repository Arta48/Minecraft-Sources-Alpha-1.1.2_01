...
public class dm extends ge {
   ...
   public dm(cn var1) {
      super(var1);
      this.aB = 1.62F;
      this.c((double)var1.o + (double)0.5F, (double)(var1.p + 1), (double)var1.q + (double)0.5F, 0.0F, 0.0F);
      this.E = 20;
      this.x = "humanoid";
      this.w = 180.0F;
      this.aS = 20;
   ...
   public void j() {
      ...
      float var2 = (float)Math.atan(-this.ao * (double)0.2F) * 15.0F;
      if (var1 > 0.1F) {
         var1 = 0.1F;
      }
      ...
      if (this.E > 0) {
         List var3 = this.ag.b((kh)this, (cf)this.au.b((double)1.0F, (double)0.0F, (double)1.0F));
         if (var3 != null) {
   ...
   public void b(kh var1) {
      ...
      this.b.g();
      if (var1 != null) {
         this.an = (double)(-eo.b((this.I + this.aq) * (float)Math.PI / 180.0F) * 0.1F);
         this.ap = (double)(-eo.a((this.I + this.aq) * (float)Math.PI / 180.0F) * 0.1F);
      } else {
         this.an = this.ap = (double)0.0F;
      }
   ...
   public void a(ev var1, boolean var2) {
      if (var1 != null) {
         dx var3 = new dx(this.ag, this.ak, this.al - (double)0.3F + (double)this.s(), this.am, var1);
         var3.c = 40;
         float var4 = 0.1F;
         if (var2) {
            float var5 = this.aQ.nextFloat() * 0.5F;
            float var6 = this.aQ.nextFloat() * (float)Math.PI * 2.0F;
            var3.an = (double)(-eo.a(var6) * var5);
            var3.ap = (double)(eo.b(var6) * var5);
            var3.ao = (double)0.2F;
         } else {
            var4 = 0.3F;
            var3.an = (double)(-eo.a(this.aq / 180.0F * (float)Math.PI) * eo.b(this.ar / 180.0F * (float)Math.PI) * var4);
            var3.ap = (double)(eo.b(this.aq / 180.0F * (float)Math.PI) * eo.b(this.ar / 180.0F * (float)Math.PI) * var4);
            var3.ao = (double)(-eo.a(this.ar / 180.0F * (float)Math.PI) * var4 + 0.1F);
            var4 = 0.02F;
            float var10 = this.aQ.nextFloat() * (float)Math.PI * 2.0F;
            var4 *= this.aQ.nextFloat();
            var3.an += Math.cos((double)var10) * (double)var4;
            var3.ao += (double)((this.aQ.nextFloat() - this.aQ.nextFloat()) * 0.1F);
            var3.ap += Math.sin((double)var10) * (double)var4;
         }

...
public class e implements im {
   ...
   int d = 0;
   int e = df.a(1);
   double f = (double)-9999.0F;
   double g = (double)-9999.0F;
   double h = (double)-9999.0F;
   public float i;
   int j = 0;
   ...
   public e(Minecraft var1, ey var2) {
      ...
      for(int var11 = -var6 * var7; var11 <= var6 * var7; var11 += var6) {
         for(int var12 = -var6 * var7; var12 <= var6 * var7; var12 += var6) {
            var4.a((double)(var11 + var6), (double)var5, (double)(var12 + 0));
            var4.a((double)(var11 + 0), (double)var5, (double)(var12 + 0));
            var4.a((double)(var11 + 0), (double)var5, (double)(var12 + var6));
            var4.a((double)(var11 + var6), (double)var5, (double)(var12 + var6));
         }
      }
   ...
   private void f() {
      ...
      for(int var3 = 0; var3 < 1500; ++var3) {
         ...
         if (var12 < (double)1.0F && var12 > 0.01) {
            var12 = (double)1.0F / Math.sqrt(var12);
            var4 *= var12;
            var6 *= var12;
            var8 *= var12;
            double var14 = var4 * (double)100.0F;
            double var16 = var6 * (double)100.0F;
            double var18 = var8 * (double)100.0F;
            ...
            double var32 = var1.nextDouble() * Math.PI * (double)2.0F;
   ...
   public void a(cn var1) {
      ...
      this.f = (double)-9999.0F;
      this.g = (double)-9999.0F;
      this.h = (double)-9999.0F;
      kx.a.a(var1);
      this.k = var1;
      this.u = new bc(var1);
      if (var1 != null) {
   ...
   public void a() {
      ...
      for(int var8 = 0; var8 < this.p; ++var8) {
         for(int var5 = 0; var5 < this.q; ++var5) {
            for(int var6 = 0; var6 < this.r; ++var6) {
               this.o[(var6 * this.q + var5) * this.p + var8] = new bn(this.k, this.a, var8 * 16, var5 * 16, var6 * 16, 16, this.s + var2);
               if (this.w) {
                  this.o[(var6 * this.q + var5) * this.p + var8].z = this.v.get(var3);
               }

               this.o[(var6 * this.q + var5) * this.p + var8].y = false;
               this.o[(var6 * this.q + var5) * this.p + var8].x = true;
               this.o[(var6 * this.q + var5) * this.p + var8].o = true;
               this.o[(var6 * this.q + var5) * this.p + var8].w = var3++;
               this.o[(var6 * this.q + var5) * this.p + var8].f();
               this.n[(var6 * this.q + var5) * this.p + var8] = this.o[(var6 * this.q + var5) * this.p + var8];
               this.m.add(this.o[(var6 * this.q + var5) * this.p + var8]);
               var2 += 3;
            }
         }
      }
      ...
      if (this.k != null) {
         bi var9 = this.t.g;
         this.b(eo.b(var9.ak), eo.b(var9.al), eo.b(var9.am));
         Arrays.sort(this.n, new fb(var9));
      }
   ...
   public void a(aj var1, oe var2, float var3) {
      if (this.I > 0) {
         ...
         for(int var8 = 0; var8 < this.a.size(); ++var8) {
            fz.a.a((ic)this.a.get(var8), var3);
         }
   ...
   public int a(dm var1, int var2, double var3) {
      ...
      if (var11 * var11 + var13 * var13 + var15 * var15 > (double)16.0F) {
         this.f = var1.ak;
         this.g = var1.al;
         this.h = var1.am;
      ...
      if (this.w && !this.t.y.g && var2 == 0) {
         ...
         var17 += this.a(var18, var19, var2, var3);
               ...
               if (this.n[var23].e()) {
                  ...
                  if (this.n[var23].o && !this.n[var23].y) {
                     ...
                     if (this.x % var25 == var23 % var25) {
                        ...
                        ARBOcclusionQuery.glBeginQueryARB(35092, this.n[var23].z);
                        this.n[var23].d();
         ...
         var17 += this.a(0, this.n.length, var2, var3);
      }
   ...
   private void a(int var1, int var2) {
      for(int var3 = var1; var3 < var2; ++var3) {
         if (this.n[var3].y) {
            this.c.clear();
            ARBOcclusionQuery.glGetQueryObjectuARB(this.n[var3].z, 34919, this.c);
            if (this.c.get(0) != 0) {
               this.n[var3].y = false;
               this.c.clear();
               ARBOcclusionQuery.glGetQueryObjectuARB(this.n[var3].z, 34918, this.c);
   ...
   private int a(int var1, int var2, int var3, double var4) {
      ...
      for(int var15 = 0; var15 < this.S.length; ++var15) {
         this.S[var15].b();
      }

      for(int var21 = 0; var21 < this.R.size(); ++var21) {
         bn var16 = (bn)this.R.get(var21);
         int var17 = -1;
   ...
   public void a(float var1) {
      ...
      GL11.glTranslatef(var13, var14, var9);
      GL11.glRotatef(0.0F, 0.0F, 0.0F, 1.0F);
      GL11.glRotatef(this.k.c(var1) * 360.0F, 1.0F, 0.0F, 0.0F);
      float var10 = 30.0F;
      GL11.glBindTexture(3553, this.l.a("/terrain/sun.png"));
      var12.b();
      var12.a((double)(-var10), (double)100.0F, (double)(-var10), (double)0.0F, (double)0.0F);
      var12.a((double)var10, (double)100.0F, (double)(-var10), (double)1.0F, (double)0.0F);
      var12.a((double)var10, (double)100.0F, (double)var10, (double)1.0F, (double)1.0F);
      var12.a((double)(-var10), (double)100.0F, (double)var10, (double)0.0F, (double)1.0F);
      var12.a();
      var10 = 20.0F;
   ...
   public void b(float var1) {
      if (this.t.y.i) {
         ...
         double var23 = this.t.g.ah + (this.t.g.ak - this.t.g.ah) * (double)var1 + (double)(((float)this.x + var1) * 0.03F);
         double var13 = this.t.g.aj + (this.t.g.am - this.t.g.aj) * (double)var1;
         int var15 = eo.b(var23 / (double)2048.0F);
         int var16 = eo.b(var13 / (double)2048.0F);
         ...
         for(int var20 = -var3 * var4; var20 < var3 * var4; var20 += var3) {
            for(int var21 = -var3 * var4; var21 < var3 * var4; var21 += var3) {
               var5.a((double)(var20 + 0), (double)var17, (double)(var21 + var3), (double)((float)(var20 + 0) * var22 + var18), (double)((float)(var21 + var3) * var22 + var19));
               var5.a((double)(var20 + var3), (double)var17, (double)(var21 + var3), (double)((float)(var20 + var3) * var22 + var18), (double)((float)(var21 + var3) * var22 + var19));
               var5.a((double)(var20 + var3), (double)var17, (double)(var21 + 0), (double)((float)(var20 + var3) * var22 + var18), (double)((float)(var21 + 0) * var22 + var19));
               var5.a((double)(var20 + 0), (double)var17, (double)(var21 + 0), (double)((float)(var20 + 0) * var22 + var18), (double)((float)(var21 + 0) * var22 + var19));
            }
         }
   ...
   public void c(float var1) {
      ...
      double var8 = (this.t.g.aj + (this.t.g.am - this.t.g.aj) * (double)var1) / (double)var4 + (double)0.33F;
      float var10 = 108.0F - var2 + 0.33F;
      int var11 = eo.b(var6 / (double)2048.0F);
      int var12 = eo.b(var8 / (double)2048.0F);
      ...
      float var35 = (float)(var6 * (double)0.0F);
      float var37 = (float)(var8 * (double)0.0F);
      float var39 = 0.00390625F;
      var35 = (float)eo.b(var6) * var39;
      var37 = (float)eo.b(var8) * var39;
         ...
         for(int var26 = -var23 + 1; var26 <= var23; ++var26) {
            for(int var27 = -var23 + 1; var27 <= var23; ++var27) {
               ...
               if (var10 > -var5 - 1.0F) {
                  ...
                  var3.a((double)(var30 + 0.0F), (double)(var10 + 0.0F), (double)(var31 + (float)var22), (double)((var28 + 0.0F) * var39 + var35), (double)((var29 + (float)var22) * var39 + var37));
                  var3.a((double)(var30 + (float)var22), (double)(var10 + 0.0F), (double)(var31 + (float)var22), (double)((var28 + (float)var22) * var39 + var35), (double)((var29 + (float)var22) * var39 + var37));
                  var3.a((double)(var30 + (float)var22), (double)(var10 + 0.0F), (double)(var31 + 0.0F), (double)((var28 + (float)var22) * var39 + var35), (double)((var29 + 0.0F) * var39 + var37));
                  var3.a((double)(var30 + 0.0F), (double)(var10 + 0.0F), (double)(var31 + 0.0F), (double)((var28 + 0.0F) * var39 + var35), (double)((var29 + 0.0F) * var39 + var37));
               }

               if (var10 <= var5 + 1.0F) {
                  var3.a(var14, var15, var16, 0.8F);
                  var3.b(0.0F, 1.0F, 0.0F);
                  var3.a((double)(var30 + 0.0F), (double)(var10 + var5 - var24), (double)(var31 + (float)var22), (double)((var28 + 0.0F) * var39 + var35), (double)((var29 + (float)var22) * var39 + var37));
                  var3.a((double)(var30 + (float)var22), (double)(var10 + var5 - var24), (double)(var31 + (float)var22), (double)((var28 + (float)var22) * var39 + var35), (double)((var29 + (float)var22) * var39 + var37));
                  var3.a((double)(var30 + (float)var22), (double)(var10 + var5 - var24), (double)(var31 + 0.0F), (double)((var28 + (float)var22) * var39 + var35), (double)((var29 + 0.0F) * var39 + var37));
                  var3.a((double)(var30 + 0.0F), (double)(var10 + var5 - var24), (double)(var31 + 0.0F), (double)((var28 + 0.0F) * var39 + var35), (double)((var29 + 0.0F) * var39 + var37));
               }
               ...
               if (var26 > -1) {
                  ...
                  for(int var32 = 0; var32 < var22; ++var32) {
                     var3.a((double)(var30 + (float)var32 + 0.0F), (double)(var10 + 0.0F), (double)(var31 + (float)var22), (double)((var28 + (float)var32 + 0.5F) * var39 + var35), (double)((var29 + (float)var22) * var39 + var37));
                     var3.a((double)(var30 + (float)var32 + 0.0F), (double)(var10 + var5), (double)(var31 + (float)var22), (double)((var28 + (float)var32 + 0.5F) * var39 + var35), (double)((var29 + (float)var22) * var39 + var37));
                     var3.a((double)(var30 + (float)var32 + 0.0F), (double)(var10 + var5), (double)(var31 + 0.0F), (double)((var28 + (float)var32 + 0.5F) * var39 + var35), (double)((var29 + 0.0F) * var39 + var37));
                     var3.a((double)(var30 + (float)var32 + 0.0F), (double)(var10 + 0.0F), (double)(var31 + 0.0F), (double)((var28 + (float)var32 + 0.5F) * var39 + var35), (double)((var29 + 0.0F) * var39 + var37));
                  }
               }
               ...
               if (var26 <= 1) {
                  ...
                  for(int var40 = 0; var40 < var22; ++var40) {
                     var3.a((double)(var30 + (float)var40 + 1.0F - var24), (double)(var10 + 0.0F), (double)(var31 + (float)var22), (double)((var28 + (float)var40 + 0.5F) * var39 + var35), (double)((var29 + (float)var22) * var39 + var37));
                     var3.a((double)(var30 + (float)var40 + 1.0F - var24), (double)(var10 + var5), (double)(var31 + (float)var22), (double)((var28 + (float)var40 + 0.5F) * var39 + var35), (double)((var29 + (float)var22) * var39 + var37));
                     var3.a((double)(var30 + (float)var40 + 1.0F - var24), (double)(var10 + var5), (double)(var31 + 0.0F), (double)((var28 + (float)var40 + 0.5F) * var39 + var35), (double)((var29 + 0.0F) * var39 + var37));
                     var3.a((double)(var30 + (float)var40 + 1.0F - var24), (double)(var10 + 0.0F), (double)(var31 + 0.0F), (double)((var28 + (float)var40 + 0.5F) * var39 + var35), (double)((var29 + 0.0F) * var39 + var37));
                  }
               }
               ...
               if (var27 > -1) {
                  ...
                  for(int var41 = 0; var41 < var22; ++var41) {
                     var3.a((double)(var30 + 0.0F), (double)(var10 + var5), (double)(var31 + (float)var41 + 0.0F), (double)((var28 + 0.0F) * var39 + var35), (double)((var29 + (float)var41 + 0.5F) * var39 + var37));
                     var3.a((double)(var30 + (float)var22), (double)(var10 + var5), (double)(var31 + (float)var41 + 0.0F), (double)((var28 + (float)var22) * var39 + var35), (double)((var29 + (float)var41 + 0.5F) * var39 + var37));
                     var3.a((double)(var30 + (float)var22), (double)(var10 + 0.0F), (double)(var31 + (float)var41 + 0.0F), (double)((var28 + (float)var22) * var39 + var35), (double)((var29 + (float)var41 + 0.5F) * var39 + var37));
                     var3.a((double)(var30 + 0.0F), (double)(var10 + 0.0F), (double)(var31 + (float)var41 + 0.0F), (double)((var28 + 0.0F) * var39 + var35), (double)((var29 + (float)var41 + 0.5F) * var39 + var37));
                  }
               }
               ...
               if (var27 <= 1) {
                  ...
                  for(int var42 = 0; var42 < var22; ++var42) {
                     var3.a((double)(var30 + 0.0F), (double)(var10 + var5), (double)(var31 + (float)var42 + 1.0F - var24), (double)((var28 + 0.0F) * var39 + var35), (double)((var29 + (float)var42 + 0.5F) * var39 + var37));
                     var3.a((double)(var30 + (float)var22), (double)(var10 + var5), (double)(var31 + (float)var42 + 1.0F - var24), (double)((var28 + (float)var22) * var39 + var35), (double)((var29 + (float)var42 + 0.5F) * var39 + var37));
                     var3.a((double)(var30 + (float)var22), (double)(var10 + 0.0F), (double)(var31 + (float)var42 + 1.0F - var24), (double)((var28 + (float)var22) * var39 + var35), (double)((var29 + (float)var42 + 0.5F) * var39 + var37));
                     var3.a((double)(var30 + 0.0F), (double)(var10 + 0.0F), (double)(var31 + (float)var42 + 1.0F - var24), (double)((var28 + 0.0F) * var39 + var35), (double)((var29 + (float)var42 + 0.5F) * var39 + var37));
                  }
               }
   ...
   public void a(dm var1, mf var2, int var3, ev var4, float var5) {
      ...
      if (var3 == 0) {
         if (this.i > 0.0F) {
            ...
            GL11.glPushMatrix();
            int var8 = this.k.a(var2.b, var2.c, var2.d);
            ...
            var6.a();
            var6.b((double)0.0F, (double)0.0F, (double)0.0F);
         ...
         int var17 = this.l.a("/terrain.png");
   ...
   public void a(String var1, double var2, double var4, double var6, double var8, double var10, double var12) {
      ...
      if (!(var14 * var14 + var16 * var16 + var18 * var18 > (double)256.0F)) {
         if (var1 == "bubble") {

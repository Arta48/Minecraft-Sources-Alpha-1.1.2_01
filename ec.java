   ...
   public boolean a(ev var1, dm var2, cn var3, int var4, int var5, int var6, int var7) {
      if (var7 != 1) {
         ...
         if (!var8.a(var3, var4, var5, var6)) {
            ...
            int var9 = eo.b((double)((var2.aq + 180.0F) * 4.0F / 360.0F) - (double)0.5F) & 3;
            byte var10 = 0;
            byte var11 = 0;
            if (var9 == 0) {
               var11 = 1;
            ...
            boolean var14 = var3.a(var4 - var10, var5, var6 - var11) == var8.bc || var3.a(var4 - var10, var5 + 1, var6 - var11) == var8.bc;
            boolean var15 = var3.a(var4 + var10, var5, var6 + var11) == var8.bc || var3.a(var4 + var10, var5 + 1, var6 + var11) == var8.bc;
            boolean var16 = false;
            if (var14 && !var15) {
               var16 = true;
            } else if (var13 > var12) {
            ...
            var3.d(var4, var5, var6, var8.bc);
            var3.b(var4, var5, var6, var9);
            var3.d(var4, var5 + 1, var6, var8.bc);

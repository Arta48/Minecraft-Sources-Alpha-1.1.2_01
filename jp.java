...
public abstract class jp extends ly {
   ...
   public boolean c(nm var1, int var2, int var3, int var4, int var5) {
      ...
      if (var6 == this.bn) {
         ...
         return var5 == 1 ? true : super.c(var1, var2, var3, var4, var5);
      }
   }
   ...
   private aj e(nm var1, int var2, int var3, int var4) {
      aj var5 = aj.b((double)0.0F, (double)0.0F, (double)0.0F);
      ...
      for(int var7 = 0; var7 < 4; ++var7) {
         ...
         if (var11 < 0) {
            ...
            var5 = var5.c((double)((var8 - var2) * var16), (double)((var3 - var3) * var16), (double)((var10 - var4) * var16));
         }
      }

      if (var1.e(var2, var3, var4) >= 8) {
         boolean var14 = false;
         if (var14 || this.c(var1, var2, var3, var4 - 1, 2)) {
            var14 = true;
         }

         if (var14 || this.c(var1, var2, var3, var4 + 1, 3)) {
            var14 = true;
         }

         if (var14 || this.c(var1, var2 - 1, var3, var4, 4)) {
            var14 = true;
         }

         if (var14 || this.c(var1, var2 + 1, var3, var4, 5)) {
            var14 = true;
         }

         if (var14 || this.c(var1, var2, var3 + 1, var4 - 1, 2)) {
            var14 = true;
         }

         if (var14 || this.c(var1, var2, var3 + 1, var4 + 1, 3)) {
            var14 = true;
         }

         if (var14 || this.c(var1, var2 - 1, var3 + 1, var4, 4)) {
            var14 = true;
         }

         if (var14 || this.c(var1, var2 + 1, var3 + 1, var4, 5)) {
            var14 = true;
         }

         if (var14) {
            var5 = var5.b().c((double)0.0F, (double)-6.0F, (double)0.0F);
         }
      }
   ...
   public void b(cn var1, int var2, int var3, int var4, Random var5) {
      ...
      if (this.bn == gb.g && var1.f(var2, var3 + 1, var4) == gb.a && !var1.g(var2, var3 + 1, var4) && var5.nextInt(100) == 0) {
         ...
         var1.a("lava", var12, var8, var10, (double)0.0F, (double)0.0F, (double)0.0F);
      }
   ...
   public static double a(nm var0, int var1, int var2, int var3, gb var4) {
      ...
      return var5.a == (double)0.0F && var5.c == (double)0.0F ? (double)-1000.0F : Math.atan2(var5.c, var5.a) - (Math.PI / 2D);
   }
   ...
   protected void i(cn var1, int var2, int var3, int var4) {
      ...
      for(int var5 = 0; var5 < 8; ++var5) {
         var1.a("largesmoke", (double)var2 + Math.random(), (double)var3 + 1.2, (double)var4 + Math.random(), (double)0.0F, (double)0.0F, (double)0.0F);
      }

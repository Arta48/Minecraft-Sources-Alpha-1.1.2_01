public class ek extends ge {
   ...
   protected void b_() {
      ...
      if (this.g || this.f == null || this.a != null && this.aQ.nextInt(20) != 0) {
         if (this.a == null && this.aQ.nextInt(80) == 0 || this.aQ.nextInt(80) == 0) {
            boolean var21 = false;
            int var3 = -1;
            int var4 = -1;
            int var5 = -1;
            ...
            for(int var7 = 0; var7 < 10; ++var7) {
               int var8 = eo.b(this.ak + (double)this.aQ.nextInt(13) - (double)6.0F);
               int var9 = eo.b(this.al + (double)this.aQ.nextInt(7) - (double)3.0F);
               int var10 = eo.b(this.am + (double)this.aQ.nextInt(13) - (double)6.0F);
      ...
      if (this.a != null && this.aQ.nextInt(100) != 0) {
         ...
         if (var25 != null) {
            ...
            if (this.g && this.f != null) {
               ...
               float var20 = this.aq;
               this.aq = (float)(Math.atan2(var18, var16) * (double)180.0F / (double)(float)Math.PI) - 90.0F;
               var15 = (var20 - this.aq + 90.0F) * (float)Math.PI / 180.0F;

...
public class bw extends ak {
   ...
   public void a(jc var1, double var2, double var4, double var6, float var8, float var9) {
      this.d.setSeed(187L);
      GL11.glPushMatrix();
   ...
   private void a(jc var1, int var2, int var3, int var4, int var5) {
   ...
   private void a(jc var1, float var2, float var3) {
      int var4 = eo.b(var1.ak);
      int var5 = eo.b(var1.al + (double)(var3 / 16.0F));
      int var6 = eo.b(var1.am);
      if (var1.a == 0) {
         var4 = eo.b(var1.ak + (double)(var2 / 16.0F));
      }

      if (var1.a == 1) {
         var6 = eo.b(var1.am - (double)(var2 / 16.0F));
      }
      ...
      float var7 = this.a.g.c(var4, var5, var6);

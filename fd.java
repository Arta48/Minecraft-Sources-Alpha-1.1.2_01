...
public class fd extends ly {
   ...
   public void a_(cn var1, int var2, int var3, int var4, int var5) {
      int var6 = di.aB.aS;
      float var7 = 0.7F;
      double var8 = (double)(var1.n.nextFloat() * var7) + (double)(1.0F - var7) * (double)0.5F;
      double var10 = (double)(var1.n.nextFloat() * var7) + (double)(1.0F - var7) * (double)0.5F;
      double var12 = (double)(var1.n.nextFloat() * var7) + (double)(1.0F - var7) * (double)0.5F;
   ...
   public boolean c(nm var1, int var2, int var3, int var4, int var5) {
      ...
      if (var5 == 1) {
         ...
         return var6 == this.bn ? false : super.c(var1, var2, var3, var4, var5);
      }
   }
}

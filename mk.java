...
class mk {
   ...
   public mk(if var1, cn var2, int var3, int var4, int var5) {
      this.a = var1;
   ...
   private void b() {
      for(int var1 = 0; var1 < this.g.size(); ++var1) {
         mk var2 = this.a((mt)this.g.get(var1));
         if (var2 != null && var2.b(this)) {
            this.g.set(var1, new mt(var2.c, var2.d, var2.e));
         } else {
            this.g.remove(var1--);
         }
      }
   ...
   private boolean a(int var1, int var2, int var3) {
      if (this.b.a(var1, var2, var3) == this.a.bc) {
         return true;
      } else if (this.b.a(var1, var2 + 1, var3) == this.a.bc) {
         return true;
      } else {
         return this.b.a(var1, var2 - 1, var3) == this.a.bc;
      }
   }

   private mk a(mt var1) {
      if (this.b.a(var1.a, var1.b, var1.c) == this.a.bc) {
         return new mk(this.a, this.b, var1.a, var1.b, var1.c);
      } else if (this.b.a(var1.a, var1.b + 1, var1.c) == this.a.bc) {
         return new mk(this.a, this.b, var1.a, var1.b + 1, var1.c);
      } else {
         return this.b.a(var1.a, var1.b - 1, var1.c) == this.a.bc ? new mk(this.a, this.b, var1.a, var1.b - 1, var1.c) : null;
      }
   }

   private boolean b(mk var1) {
      for(int var2 = 0; var2 < this.g.size(); ++var2) {
         mt var3 = (mt)this.g.get(var2);
   ...
   private boolean c(mk var1) {
      if (this.b(var1)) {
         ...
         mt var2 = (mt)this.g.get(0);
         return var1.d == this.d && var2.b == this.d ? true : true;
      }
   }

   private void d(mk var1) {
      this.g.add(new mt(var1.c, var1.d, var1.e));
   ...
   private boolean c(int var1, int var2, int var3) {
      mk var4 = this.a(new mt(var1, var2, var3));
      if (var4 == null) {
         return false;
      } else {
         var4.b();
   ...
   public void a(boolean var1) {
      ...
      for(int var7 = 0; var7 < this.g.size(); ++var7) {
         mk var8 = this.a((mt)this.g.get(var7));
         if (var8 != null) {
            var8.b();
            if (var8.c(this)) {
               var8.d(this);

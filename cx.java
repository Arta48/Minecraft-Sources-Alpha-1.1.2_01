...
public class cx extends bh {
   ...
   public void a(int var1, int var2, float var3) {
      ...
      float var5 = 1.8F - eo.e(eo.a((float)(System.currentTimeMillis() % 1000L) / 1000.0F * (float)Math.PI * 2.0F) * 0.1F);
   ...
   private void a(float var1) {
      if (this.i == null) {
         ...
         for(int var2 = 0; var2 < this.i.length; ++var2) {
            for(int var3 = 0; var3 < this.i[var2].length; ++var3) {
      ...
      int var15 = 120 * var14.a;
      GLU.gluPerspective(70.0F, (float)this.b.c / (float)var15, 0.05F, 100.0F);
      GL11.glViewport(0, this.b.d - var15, this.b.c, var15);

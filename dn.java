...
public class dn extends ak {
   ...
   public void a(ge var1, double var2, double var4, double var6, float var8, float var9) {
      ...
      try {
         ...
         if (var1.J > 0) {
            float var14 = ((float)var1.J + var9 - 1.0F) / 20.0F * 1.6F;
            var14 = eo.c(var14);
            if (var14 > 1.0F) {
               var14 = 1.0F;
            }
         ...
         this.a(var1, var9);
         GL11.glTranslatef(0.0F, -24.0F * var26 - 0.0078125F, 0.0F);
         ...
         GL11.glEnable(3008);
         this.d.b(var16, var15, var13, var11 - var10, var12, var26);

         for(int var17 = 0; var17 < 4; ++var17) {
            if (this.a(var1, var17)) {
               this.e.b(var16, var15, var13, var11 - var10, var12, var26);
               GL11.glDisable(3042);
               GL11.glEnable(3008);
            }
         }
         ...
         this.b(var1, var9);
         float var27 = var1.a(var9);
         int var18 = this.a(var1, var27, var9);

public class cr extends fo {
   ...
   public void a(float var1, float var2, float var3, float var4, float var5, float var6) {
      this.a.e = var4 / (180F / (float)Math.PI);
      this.a.d = var5 / (180F / (float)Math.PI);
      this.b.e = this.a.e;
      this.b.d = this.a.d;
      this.d.d = eo.b(var1 * 0.6662F + (float)Math.PI) * 2.0F * var2 * 0.5F;
      this.e.d = eo.b(var1 * 0.6662F) * 2.0F * var2 * 0.5F;
      this.d.f = 0.0F;
      this.e.f = 0.0F;
      this.f.d = eo.b(var1 * 0.6662F) * 1.4F * var2;
      this.g.d = eo.b(var1 * 0.6662F + (float)Math.PI) * 1.4F * var2;
      this.f.e = 0.0F;
      this.g.e = 0.0F;
      if (this.l) {
         ip var10000 = this.d;
         var10000.d += (-(float)Math.PI / 5F);
         var10000 = this.e;
         var10000.d += (-(float)Math.PI / 5F);
         this.f.d = -1.2566371F;
         this.g.d = -1.2566371F;
         this.f.e = ((float)Math.PI / 10F);
         this.g.e = (-(float)Math.PI / 10F);
      }

      if (this.h) {
         this.e.d = this.e.d * 0.5F - ((float)Math.PI / 10F);
      }

      if (this.i) {
         this.d.d = this.d.d * 0.5F - ((float)Math.PI / 10F);
      }
      ...
      if (this.k > -9990.0F) {
         float var7 = this.k;
         this.c.e = eo.a(eo.c(var7) * (float)Math.PI * 2.0F) * 0.2F;
         ...
         var7 *= var7;
         var7 = 1.0F - var7;
         float var8 = eo.a(var7 * (float)Math.PI);
         float var9 = eo.a(this.k * (float)Math.PI) * -(this.a.d - 0.7F) * 0.75F;
         var15 = this.d;
         var15.d = (float)((double)var15.d - ((double)var8 * 1.2 + (double)var9));
         var15 = this.d;
         var15.e += this.c.e * 2.0F;
      ...
      ip var24 = this.d;
      var24.f += eo.b(var3 * 0.09F) * 0.05F + 0.05F;
      var24 = this.e;
      var24.f -= eo.b(var3 * 0.09F) * 0.05F + 0.05F;
      var24 = this.d;
      var24.d += eo.a(var3 * 0.067F) * 0.05F;
      var24 = this.e;
      var24.d -= eo.a(var3 * 0.067F) * 0.05F;
   }
}

...
class Mdct {
   ...
   void init(int var1) {
      ...
      this.log2n = (int)Math.rint(Math.log((double)var1) / Math.log((double)2.0F));
      this.n = var1;
      byte var2 = 0;
      byte var3 = 1;
      ...
      for(int var8 = 0; var8 < var1 / 4; ++var8) {
         this.trig[var2 + var8 * 2] = (float)Math.cos(Math.PI / (double)var1 * (double)(4 * var8));
         this.trig[var3 + var8 * 2] = (float)(-Math.sin(Math.PI / (double)var1 * (double)(4 * var8)));
         this.trig[var4 + var8 * 2] = (float)Math.cos(Math.PI / (double)(2 * var1) * (double)(2 * var8 + 1));
         this.trig[var5 + var8 * 2] = (float)Math.sin(Math.PI / (double)(2 * var1) * (double)(2 * var8 + 1));
      }

      for(int var13 = 0; var13 < var1 / 8; ++var13) {
         this.trig[var6 + var13 * 2] = (float)Math.cos(Math.PI / (double)var1 * (double)(4 * var13 + 2));
         this.trig[var7 + var13 * 2] = (float)(-Math.sin(Math.PI / (double)var1 * (double)(4 * var13 + 2)));
      }
   ...
   synchronized void backward(float[] var1, float[] var2) {
      ...
      for(int var15 = 0; var15 < var6; ++var15) {
         float var16 = var19[var9] * this.trig[var10 + 1] - var19[var9 + 1] * this.trig[var10];
         float var17 = -(var19[var9] * this.trig[var10] + var19[var9 + 1] * this.trig[var10 + 1]);
         var2[var25] = -var16;
         var2[var12] = var16;
         var2[var13] = var17;
         var2[var14] = var17;

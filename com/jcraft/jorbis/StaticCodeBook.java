...
class StaticCodeBook {
   ...
   private int maptype1_quantvals() {
      int var1 = .eo.b(Math.pow((double)this.entries, (double)1.0F / (double)this.dim));
   ...
   static long float32_pack(float var0) {
      ...
      int var2 = .eo.b(Math.log((double)var0) / Math.log((double)2.0F));
   ...
   static float ldexp(float var0, int var1) {
      return (float)((double)var0 * Math.pow((double)2.0F, (double)var1));
   }
}

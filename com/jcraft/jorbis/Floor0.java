...
class Floor0 extends FuncFloor {
   ...
   Object look(DspState var1, InfoMode var2, Object var3) {
      ...
      float var4 = (float)var7.ln / toBARK((float)((double)var6.rate / (double)2.0F));
      var7.linearmap = new int[var7.n];

      for(int var8 = 0; var8 < var7.n; ++var8) {
         int var9 = .eo.d(toBARK((float)((double)var6.rate / (double)2.0F / (double)var7.n * (double)var8)) * var4);
         if (var9 >= var7.ln) {
            var9 = var7.ln;
         }
   ...
   static float toBARK(float var0) {
      return (float)(13.1 * Math.atan(7.4E-4 * (double)var0) + 2.24 * Math.atan((double)(var0 * var0) * 1.85E-8) + 1.0E-4 * (double)var0);
   }
   ...
   static float fromdB(float var0) {
      return (float)Math.exp((double)var0 * 0.11512925);
   }
   ...
   static void lsp_to_lpc(float[] var0, float[] var1, int var2) {
      ...
      for(int var3 = 0; var3 < var5; ++var3) {
         var6[var3] = (float)((double)-2.0F * Math.cos((double)var0[var3 * 2]));
         var7[var3] = (float)((double)-2.0F * Math.cos((double)var0[var3 * 2 + 1]));
      }

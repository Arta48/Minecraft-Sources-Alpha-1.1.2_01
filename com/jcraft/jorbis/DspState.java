      ...
      switch (var0) {
         case 0:
            ...
            for(int var7 = 0; var7 < var2; ++var7) {
               float var8 = (float)(((double)var7 + (double)0.5F) / (double)var2 * (double)(float)Math.PI / (double)2.0F);
               var8 = (float)Math.sin((double)var8);
               var8 *= var8;
               var8 = (float)((double)var8 * (double)((float)Math.PI / 2F));
               var8 = (float)Math.sin((double)var8);
               var4[var7 + var5] = var8;
            }
            ...
            for(int var10 = 0; var10 < var3; ++var10) {
               float var15 = (float)(((double)(var3 - var10) - (double)0.5F) / (double)var3 * (double)(float)Math.PI / (double)2.0F);
               var15 = (float)Math.sin((double)var15);
               var15 *= var15;
               var15 = (float)((double)var15 * (double)((float)Math.PI / 2F));
               var15 = (float)Math.sin((double)var15);
   ...
   public int synthesis_blockin(Block var1) {
      ...
      for(int var14 = 0; var14 < this.vi.channels; ++var14) {
         ...
         for(var10 = var6; var10 < var7; ++var10) {
            float[] var10000 = this.pcm[var14];
            var10000[var15 + var10] += var1.pcm[var14][var10];
         }

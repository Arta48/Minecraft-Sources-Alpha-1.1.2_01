   ...
   public int pageseek(Page var1) {
      ...
      if (this.bodybytes + this.headerbytes > var4) {
         ...
         synchronized(this.chksum) {
            ...
            this.data[var2 + 24] = 0;
            this.data[var2 + 25] = 0;
            Page var13 = this.pageseek;
            var13.header_base = this.data;
            var13.header = var2;
            var13.header_len = this.headerbytes;
            var13.body_base = this.data;
            var13.body = var2 + this.headerbytes;
            var13.body_len = this.bodybytes;
            var13.checksum();

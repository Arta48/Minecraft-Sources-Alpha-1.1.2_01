      ...
      if (var14 != this.serialno) {
         ...
         if (var15 != this.pageno) {
            for(int var19 = this.lacing_packet; var19 < this.lacing_fill; ++var19) {
               this.body_fill -= this.lacing_vals[var19] & 255;
            }
         ...
         if (var11 != 0) {
            ...
            if (this.lacing_fill > 0) {
               int[] var23 = this.lacing_vals;
               int var24 = this.lacing_fill - 1;
               var23[var24] |= 512;
            }
         }
      ...
      if (var4 == 0) {
         ...
         if (this.b_o_s == 0) {
            ...
            for(var3 = 0; var3 < var4; ++var3) {
               if ((this.lacing_vals[var3] & 255) < 255) {
                  ++var3;
                  break;
               }
            }
            ...
            for(var3 = 0; var3 < var4 && var6 <= 4096; ++var3) {
               var6 += this.lacing_vals[var3] & 255;
         ...
         if ((this.lacing_vals[0] & 256) == 0) {
            byte[] var10000 = this.header;
            var10000[5] = (byte)(var10000[5] | 1);
         }

         if (this.b_o_s == 0) {
            byte[] var15 = this.header;
            var15[5] = (byte)(var15[5] | 2);
         }

         if (this.e_o_s != 0 && this.lacing_fill == var3) {
            byte[] var16 = this.header;
            var16[5] = (byte)(var16[5] | 4);
         }

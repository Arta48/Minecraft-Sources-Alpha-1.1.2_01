...
public class fw extends ly {
      ...
      if (this.bn == gb.e) {
         ...
         if ((var6 & 8) != 0) {
            ...
            if (Math.random() < (double)0.5F) {
               var1.a((double)var2 + (double)0.5F, (double)var3 + (double)0.5F, (double)var4 + (double)0.5F, "random.door_open", 1.0F, var1.n.nextFloat() * 0.1F + 0.9F);
            } else {
               var1.a((double)var2 + (double)0.5F, (double)var3 + (double)0.5F, (double)var4 + (double)0.5F, "random.door_close", 1.0F, var1.n.nextFloat() * 0.1F + 0.9F);
            }
   ...
   public int a(int var1, Random var2) {
      if ((var1 & 8) != 0) {
         ...
         return this.bn == gb.e ? di.az.aS : di.at.aS;
      }
   }
   ...
   public boolean a(cn var1, int var2, int var3, int var4) {
      if (var3 >= 127) {
         ...
         return var1.g(var2, var3 - 1, var4) && super.a(var1, var2, var3, var4) && super.a(var1, var2, var3 + 1, var4);
      }
   }
}

...
public class ab extends ak {
   ...
   public void a(dx var1, double var2, double var4, double var6, float var8, float var9) {
      this.e.setSeed(187L);
      ev var10 = var1.a;
      GL11.glPushMatrix();
      float var11 = eo.a(((float)var1.b + var9) / 10.0F + var1.d) * 0.1F + 0.1F;
      float var12 = (((float)var1.b + var9) / 20.0F + var1.d) * (180F / (float)Math.PI);
      byte var13 = 1;
      if (var1.a.a > 1) {
         var13 = 2;
      }
      ...
      GL11.glEnable(32826);
      if (var10.c < 256 && bc.a(ly.n[var10.c].f())) {
         GL11.glRotatef(var12, 0.0F, 1.0F, 0.0F);
         this.a("/terrain.png");
         float var27 = 0.25F;
         if (!ly.n[var10.c].c() && var10.c != ly.al.bc) {
            var27 = 0.5F;
         }
         ...
         for(int var28 = 0; var28 < var13; ++var28) {
            GL11.glPushMatrix();
            if (var28 > 0) {
               float var29 = (this.e.nextFloat() * 2.0F - 1.0F) * 0.2F / var27;
               float var30 = (this.e.nextFloat() * 2.0F - 1.0F) * 0.2F / var27;
               float var31 = (this.e.nextFloat() * 2.0F - 1.0F) * 0.2F / var27;
               GL11.glTranslatef(var29, var30, var31);
            }

            this.d.a(ly.n[var10.c]);
            GL11.glPopMatrix();
         }
      } else {
         ...
         for(int var23 = 0; var23 < var13; ++var23) {
            ...
            var15.a((double)(0.0F - var21), (double)(0.0F - var22), (double)0.0F, (double)var16, (double)var19);
            var15.a((double)(var20 - var21), (double)(0.0F - var22), (double)0.0F, (double)var17, (double)var19);
            var15.a((double)(var20 - var21), (double)(1.0F - var22), (double)0.0F, (double)var17, (double)var18);
            var15.a((double)(0.0F - var21), (double)(1.0F - var22), (double)0.0F, (double)var16, (double)var18);
            var15.a();
            GL11.glPopMatrix();
         }
      }
   ...
   public void a(kd var1, ey var2, ev var3, int var4, int var5) {
      if (var3 != null) {
   ...
   public void b(kd var1, ey var2, ev var3, int var4, int var5) {
      if (var3 != null) {
         if (var3.a > 1) {
            String var6 = "" + var3.a;
            GL11.glDisable(2896);
   ...
   private void a(ho var1, int var2, int var3, int var4, int var5, int var6) {
      var1.b();
      var1.b(var6);
      var1.a((double)(var2 + 0), (double)(var3 + 0), (double)0.0F);
      var1.a((double)(var2 + 0), (double)(var3 + var5), (double)0.0F);
      var1.a((double)(var2 + var4), (double)(var3 + var5), (double)0.0F);
      var1.a((double)(var2 + var4), (double)(var3 + 0), (double)0.0F);
      var1.a();
   }

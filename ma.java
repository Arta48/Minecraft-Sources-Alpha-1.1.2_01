public class ma extends ge implements co {
   ...
   public void e_() {
      ...
      if (this.av && !var1) {
         for(int var2 = 0; var2 < this.c * 8; ++var2) {
            float var3 = this.aQ.nextFloat() * (float)Math.PI * 2.0F;
            ...
            this.ag.a("slime", this.ak + (double)var5, this.au.b, this.am + (double)var6, (double)0.0F, (double)0.0F, (double)0.0F);
         }
   ...
   protected void b_() {
      dm var1 = this.ag.a(this, (double)16.0F);
      if (var1 != null) {
         this.b(var1, 10.0F);
      }
   ...
   public void F() {
      if (this.c > 1 && this.E == 0) {
         for(int var1 = 0; var1 < 4; ++var1) {
            ...
            var4.c(this.c / 2);
            var4.c(this.ak + (double)var2, this.al + (double)0.5F, this.am + (double)var3, this.aQ.nextFloat() * 360.0F, 0.0F);
            this.ag.a((kh)var4);
         }
      }
   ...
   public void b(dm var1) {
      if (this.c > 1 && this.c(var1) && (double)this.d(var1) < 0.6 * (double)this.c && var1.a(this, this.c)) {
   ...
   public boolean a() {
      ...
      return (this.c == 1 || this.ag.l > 0) && this.aQ.nextInt(10) == 0 && var1.a(987234911L).nextInt(10) == 0 && this.al < (double)16.0F;
   }

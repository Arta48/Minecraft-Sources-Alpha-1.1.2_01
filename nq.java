public class nq extends kh {
   ...
   public nq(cn var1, double var2, double var4, double var6, double var8, double var10, double var12) {
      ...
      this.an = var8 + (double)((float)(Math.random() * (double)2.0F - (double)1.0F) * 0.4F);
      this.ao = var10 + (double)((float)(Math.random() * (double)2.0F - (double)1.0F) * 0.4F);
      this.ap = var12 + (double)((float)(Math.random() * (double)2.0F - (double)1.0F) * 0.4F);
      ...
      this.an = this.an / (double)var15 * (double)var14 * (double)0.4F;
      this.ao = this.ao / (double)var15 * (double)var14 * (double)0.4F + (double)0.1F;
      this.ap = this.ap / (double)var15 * (double)var14 * (double)0.4F;
   ...
   public nq b(float var1) {
      this.an *= (double)var1;
      this.ao = (this.ao - (double)0.1F) * (double)var1 + (double)0.1F;
      this.ap *= (double)var1;
      return this;
   }

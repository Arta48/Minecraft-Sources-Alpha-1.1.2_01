...
public class gy extends lb {
   ...
   public void a(ha var1) {
      double var2 = (double)var1.b / (double)32.0F;
      double var4 = (double)var1.c / (double)32.0F;
      double var6 = (double)var1.d / (double)32.0F;
      dx var8 = new dx(this.f, var2, var4, var6, new ev(var1.h, var1.i));
      var8.an = (double)var1.e / (double)128.0F;
      var8.ao = (double)var1.f / (double)128.0F;
      var8.ap = (double)var1.g / (double)128.0F;
      var8.bd = var1.b;
      var8.be = var1.c;
      var8.bf = var1.d;
   ...
   public void a(gp var1) {
      double var2 = (double)var1.c / (double)32.0F;
      double var4 = (double)var1.d / (double)32.0F;
      double var6 = (double)var1.e / (double)32.0F;
   ...
   public void a(jl var1) {
      ...
      if (var2 != null) {
         ...
         var2.be = var1.c;
         var2.bf = var1.d;
         double var3 = (double)var2.bd / (double)32.0F;
         double var5 = (double)var2.be / (double)32.0F;
         double var7 = (double)var2.bf / (double)32.0F;
   ...
   public void a(eh var1) {
      ...
      var2.aL = 0.0F;
      var2.an = var2.ao = var2.ap = (double)0.0F;
      ((dm)var2).b(var3, var5, var7, var9, var10);
      var1.a = var2.ak;
      var1.b = var2.au.b;
      var1.c = var2.am;
      var1.d = var2.al;

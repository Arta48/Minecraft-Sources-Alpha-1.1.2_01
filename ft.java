...
public class ft implements aw {
   ...
   public ft(cn var1, af var2, aw var3) {
      this.c = new ga(var1, new byte['耀'], 0, 0);
      this.c.q = true;
      this.c.p = true;
      this.g = var1;
      this.e = var2;
   ...
   private ga c(int var1, int var2) {
      if (this.e == null) {
         return null;
      } else {
         try {
            ga var3 = this.e.a(this.g, var1, var2);
            if (var3 != null) {
               var3.s = this.g.c;
            }

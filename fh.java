...
public class fh extends ly {
   ...
   public void a(cn var1, int var2, int var3, int var4, cf var5, ArrayList var6) {
      var6.add(cf.b((double)var2, (double)var3, (double)var4, (double)(var2 + 1), (double)var3 + (double)1.5F, (double)(var4 + 1)));
   }
   ...
   public boolean a(cn var1, int var2, int var3, int var4) {
      if (var1.a(var2, var3 - 1, var4) == this.bc) {
         ...
         return !var1.f(var2, var3 - 1, var4).a() ? false : super.a(var1, var2, var3, var4);
      }
   }

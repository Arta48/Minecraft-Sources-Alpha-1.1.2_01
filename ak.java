...
public abstract class ak {
   ...
   private void a(kh var1, double var2, double var4, double var6, float var8) {
      ...
      while(var21 > 0.0F) {
         var17.a((double)(var18 - var19), (double)(0.0F - var20), (double)0.0F, (double)var13, (double)var15);
         var17.a((double)(0.0F - var19), (double)(0.0F - var20), (double)0.0F, (double)var12, (double)var15);
         var17.a((double)(0.0F - var19), (double)(1.4F - var20), (double)0.0F, (double)var12, (double)var14);
         var17.a((double)(var18 - var19), (double)(1.4F - var20), (double)0.0F, (double)var13, (double)var14);
         --var21;
         --var20;
         var18 *= 0.9F;
   ...
   private void a(ly var1, double var2, double var4, double var6, int var8, int var9, int var10, float var11, float var12, double var13, double var15, double var17) {
      ho var19 = ho.a;
      if (var1.c()) {
         double var20 = ((double)var11 - (var4 - ((double)var9 + var15)) / (double)2.0F) * (double)0.5F * (double)this.b().c(var8, var9, var10);
         if (!(var20 < (double)0.0F)) {
            ...
            double var26 = (double)var9 + var1.bg + var15 + (double)0.015625F;
            double var28 = (double)var10 + var1.bh + var17;
            double var30 = (double)var10 + var1.bk + var17;
            float var32 = (float)((var2 - var22) / (double)2.0F / (double)var12 + (double)0.5F);
            float var33 = (float)((var2 - var24) / (double)2.0F / (double)var12 + (double)0.5F);
            float var34 = (float)((var6 - var28) / (double)2.0F / (double)var12 + (double)0.5F);
            float var35 = (float)((var6 - var30) / (double)2.0F / (double)var12 + (double)0.5F);
   ...
   public void b(kh var1, double var2, double var4, double var6, float var8, float var9) {
      if (this.a.k.i && this.b > 0.0F) {
         ...
         float var12 = (float)(((double)1.0F - var10 / (double)256.0F) * (double)this.c);
         if (var12 > 0.0F) {
